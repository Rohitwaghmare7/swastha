...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['submit'])) {
        ...
        $occupied =  $_POST["occupied_bed"];  ;
        $occupied_icu_beds =$_POST["occupied_icu_bed"];
        $occupied_emergency_beds =$_POST["occupied_emergency_bed"];
        $occupied_general_beds =$_POST["occupied_general_bed"];
...
?>
            ...
            if ($password == $rpassword) {
                ...
                $sql3 = "INSERT INTO `hospital_info` (`hospital_id`, `hospital_name`, `city`, `address`, `state`, `pincode`, `phonenumber`, `email`,`category`, `website`, `beds`, `available_bad`,` occupied_bed`,`Total_emergency_beds`,`available_emergency_bad`,`occupied_emergency_bed`,`Total_icu_beds`,`available_icu_beds`,`occupied_icu_bed`,`Total_general_beds`,`available_general_bad`,`occupied_general_bed`, `last_updated`) VALUES ('$hospital_id', '$hospital_name', '$city', '$address', '$state', '$pincode', '$phonenumber', '$email','$category', '$website', '$beds', '$available_bad','$Total_emergency_beds','$available_emergency_bad','$Total_icu_beds','$available_icu_beds','$Total_general_beds','$available_general_bad', current_timestamp())";
    ...
    <div id="reg">
        <div class="container">
            <form action="Register.php" method="post">
                ...
                <div>
                    <label for="available_bad" placeholder="No of beds">occupied Beds: </label>
                    <input type="text" id="occupied_bed" name="occupied_bed" placeholder="Enter no. of available beds">
                </div>
                <div>
                ...
                <div>
                    <label for="available_bad" placeholder="No of beds">occupied Emergency Beds: </label>
                    <input type="text" id="occupied_emergency_bed" name="occupied_emergency_bed" placeholder="Enter no. of available beds">
                </div>
                <div>
                ...
                <div>
                    <label for="available_bad" placeholder="No of beds">occupied ICU Beds: </label>
                    <input type="text" id="occupied_icu_bed" name="occupied_icu_bed" placeholder="Enter no. of available beds">
                </div>
                <div>
                ...
                <div>
                    <label for="available_bad" placeholder="No of beds">occupied general Beds: </label>
                    <input type="text" id="occupied_general_bed" name="occupied_general_bed" placeholder="Enter no. of available beds">
                </div>
                <div>
