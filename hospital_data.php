...
<head>
  ...
  <link rel="stylesheet" href="./css/hosp_data1.css">
...
<body>
  ...
  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
    <li><a class="dropdown-item fs-4" href="./user/user_login.php">General Beds</a></li>
    <li><a class="dropdown-item fs-4" href="./user/user_login.php">Emergency Beds</a></li>
    <li><a class="dropdown-item fs-4" href="./user/user_login.php">ICU Beds</a></li>
  </ul>
</div>
    </span>
